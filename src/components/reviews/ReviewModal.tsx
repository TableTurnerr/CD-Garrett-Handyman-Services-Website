...
const GOOGLE_REVIEW_URL = BUSINESS.socials.googleBusinessProfile;
...
export default function ReviewModal() {
  ...
  const mailtoFallback = () => {
    const subject = `Feedback from ${name || "a customer"} - ${rating} star${rating === 1 ? "" : "s"}`;
      ...
      >
        ...
        {step === "rating" && (
          <>
            ...
            <p className="text-[var(--color-text-muted)] mb-7">
              How did we do? Tap a star to rate our work.
            </p>
            ...
            <form onSubmit={handleSubmit} className="grid gap-4">
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  placeholder="Tell us about the job and how we did. We'll make it right."
                  className={inputCls}
                />
