  ...
  return (
    <section className="relative overflow-hidden bg-[var(--color-sand)]">
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(199,127,26,0.30), transparent 70%)",
        }}
      />
      <div
        aria-hidden="true"
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(242,176,30,0.35), transparent 70%)",
        }}
      />

      <div className="container-pad relative section-pad text-center">
        <div className="eyebrow">A Loose Screw Somewhere</div>
